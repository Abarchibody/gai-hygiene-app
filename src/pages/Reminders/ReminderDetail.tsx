            ...
            <div className="p-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-gray-900">{reminder.titre}</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">{reminder.categorie}</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">{reminder.recurrence}</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">{reminder.statut}</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">
                    {reminder.date_debut.toLocaleDateString('fr-FR')}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">{reminder.heure}</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">
                    {reminder.created_at.toLocaleDateString('fr-FR')}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div className="p-6">
              <div className="text-center py-8">
                ...
                <p className="text-gray-500 text-sm mb-3">Aucune assignation</p>
